# ThinkPoint Privacy Policy

**Last Updated:** December 17, 2025

## 1. Introduction
ThinkPoint ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website **thinkpoint.ee** and use our software products, including the Copoint platform. We operate in accordance with the General Data Protection Regulation (GDPR) and applicable Estonian data protection laws.

> **Summary:** We value your trust. This policy outlines how we handle your data legally and securely, primarily to provide our fraud detection and project management services.

## 2. Information We Collect

### 2.1. Personal Data
We may collect personally identifiable information, such as:
*   **Identity Data:** Full name, job title, and company affiliation.
*   **Contact Data:** Business email address, phone number, and billing address.
*   **Account Credentials:** Usernames and encrypted passwords for accessing our platforms.

### 2.2. Usage & Technical Data
We automatically collect certain information when you visit, use, or navigate the Services:
*   **Device Data:** IP address, browser type, device details, and operating system.
